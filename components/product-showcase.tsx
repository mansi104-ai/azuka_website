          ...
          {products.map((product, index) => (
            ...
            >
              ...
              <CardHeader className="pb-4">
                <CardTitle className={`text-2xl font-bold ${product.iconColor} group-hover:scale-105 transition-transform duration-300`}>
                  {product.name}
                </CardTitle>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-3">
                  {product.features.map((feature, idx) => (
                    <div key={idx} className="flex items-center space-x-3 text-sm group-hover:translate-x-2 transition-transform duration-300" style={{ transitionDelay: `${idx * 100}ms` }}>
                ...
                <div className="flex space-x-3 pt-6">
                  <Button className={`flex-1 bg-gradient-to-r ${product.gradient} text-white hover:opacity-90 shadow-lg hover-lift`}>
                    Get Sample
                  </Button>
                  <Button variant="outline" className={`border-2 ${product.iconColor.replace('text-', 'border-')} ${product.iconColor} hover:${product.bgColor} hover-lift`}>
                    Learn More
