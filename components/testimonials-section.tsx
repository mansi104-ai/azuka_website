  ...
  const testimonials = [
    {
      ...
      content: 'Azuka RUFFKNOT twine has never let me down. Even in heavy monsoon conditions, the bales stay intact. My yield loss has reduced by 30% since switching.',
      rating: 5,
    ...
    },
    {
      ...
      content: 'We process 500+ tons daily. MaxKnot series handles our heavy-duty requirements perfectly. Quality is consistent and delivery is always on time.',
      rating: 5,
    ...
    },
    {
      ...
      content: 'AgriForce net wraps have revolutionized our operations. Bales arrive in perfect condition, reducing our processing costs significantly.',
      rating: 5,
    ...
    },
    {
      ...
      content: 'The environmental mission of Azuka aligns with our values. We are proud to contribute to reducing field burning while getting superior quality products.',
      rating: 5,
          ...
          {testimonials.map((testimonial, index) => (
            ...
            >
              <CardContent className="p-8 relative">
                ...
                {/* Quote Icon */}
                <div className={`absolute top-6 right-6 w-12 h-12 bg-gradient-to-br ${testimonial.gradient} rounded-full flex items-center justify-center shadow-lg opacity-20 group-hover:opacity-100 transition-opacity duration-500`}>
                ...
                <div className="relative z-10">
                  ...
                  {/* Testimonial Content */}
                  <blockquote className="text-lg text-gray-700 mb-6 italic leading-relaxed group-hover:text-gray-900 transition-colors duration-300">
                    "{testimonial.content}"
                  </blockquote>
                  ...
                  <div className="flex items-center space-x-4">
                    <div className="relative">
                      <div className={`absolute inset-0 bg-gradient-to-br ${testimonial.gradient} rounded-full opacity-20 group-hover:opacity-40 transition-opacity duration-500`}></div>
                      <Image
                    ...
                    <div>
                      ...
                      <div className={`text-sm font-medium bg-gradient-to-r ${testimonial.gradient} bg-clip-text text-transparent`}>
        ...
        <div className="text-center">
          <div className="inline-flex items-center justify-center space-x-12 glass rounded-3xl px-12 py-8 shadow-xl-colored">
            ...
            <div className="text-center group hover-lift">
              ...
              <div className="text-3xl font-black bg-gradient-to-r from-purple-500 to-purple-700 bg-clip-text text-transparent">10K+</div>
