  ...
  return (
    <section className="py-16 bg-gradient-to-br from-green-50 via-blue-50 to-purple-50 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
        ...
        <div
          className="absolute bottom-20 right-20 w-80 h-80 bg-blue-200 rounded-full opacity-15 animate-float blur-3xl"
          style={{ animationDelay: "4s" }}
        ></div>
        <div
          className="absolute top-1/2 left-1/2 w-72 h-72 bg-purple-200 rounded-full opacity-10 animate-float blur-3xl"
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8 animate-slide-in-left">
            ...
            <div className="space-y-4">
              ...
              <h2 className="text-3xl lg:text-5xl font-black text-gray-900 leading-tight">{t("mission.title")}</h2>

              <p className="text-lg lg:text-xl text-gray-700 leading-relaxed">{t("mission.subtitle")}</p>
            </div>
                ...
                >
                  <CardContent className="p-6">
                    <div className="flex items-center space-x-6">
                      <div
                        className={`w-16 h-16 bg-gradient-to-br ${impact.color} rounded-2xl flex items-center justify-center shadow-lg animate-pulse-glow`}
                      >
                      ...
                      <div className="flex-1">
                        <div className="flex items-baseline space-x-2">
                          <span
                            className={`text-4xl font-black bg-gradient-to-r ${impact.color} bg-clip-text text-transparent`}
                          >
                            {impact.value}
                          </span>
            ...
            <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-6">
              ...
              <Button
                size="lg"
                variant="outline"
                className="border-2 border-green-600 text-green-600 hover:bg-green-50 hover-lift shadow-lg px-8 py-4 text-lg bg-transparent"
              >
          ...
          <div className="relative animate-slide-in-right">
            ...
            <div className="absolute bottom-8 left-8 right-8 glass rounded-2xl p-8 z-20 animate-float shadow-xl-colored">
              <div className="text-center">
                ...
                <div className="mt-4 text-sm font-semibold text-gray-600">- Azuka Agri Mission Statement</div>
              </div>
            </div>
            ...
            <div
              className="absolute top-1/3 -left-6 glass rounded-2xl p-4 z-20 animate-float"
