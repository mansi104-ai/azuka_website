...
export function Hero() {
  ...
  return (
    <section className="relative overflow-hidden gradient-hero py-12 lg:py-20 flex items-center">
      ...
      <div
        className="absolute bottom-20 left-20 w-96 h-96 bg-blue-300 rounded-full opacity-15 animate-float blur-3xl"
        style={{ animationDelay: "3s" }}
      ></div>
      <div
        className="absolute top-1/2 left-1/2 w-64 h-64 bg-blue-400 rounded-full opacity-10 animate-float blur-3xl"
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className={`space-y-6 ${isVisible ? "animate-slide-in-left" : "opacity-0"}`}>
            ...
            <div className="space-y-4">
              <h1 className="text-4xl lg:text-6xl font-black leading-tight">
                ...
                <span className="text-gray-900 block animate-fade-in-up" style={{ animationDelay: "0.2s" }}>
                  {t("hero.title2")}
                </span>
              </h1>

              <p
                className="text-lg lg:text-xl text-gray-700 leading-relaxed animate-fade-in-up"
              ...
              <div className="flex flex-col sm:flex-row gap-4 animate-fade-in-up" style={{ animationDelay: "0.6s" }}>
                <Button
                  size="lg"
                  className="gradient-blue text-white hover:opacity-90 hover-lift shadow-xl text-lg px-8 py-4"
                >
                ...
                <Button
                  size="lg"
                  variant="outline"
                  className="border-2 border-blue-600 text-blue-600 hover:bg-blue-50 hover-lift shadow-lg text-lg px-8 py-4 bg-transparent"
                >
            ...
            <div
              className="flex items-center justify-between pt-8 border-t-2 border-blue-200 animate-fade-in-up"
          ...
          <div className={`relative ${isVisible ? "animate-slide-in-right" : "opacity-0"}`}>
            ...
            <div
              className="absolute -bottom-6 -left-6 glass rounded-2xl p-6 z-20 animate-float"
              style={{ animationDelay: "3s" }}
            >
              <div className="text-center">
            ...
            <div
              className="absolute top-1/2 -left-4 glass rounded-2xl p-4 z-20 animate-float"
              style={{ animationDelay: "6s" }}
            >
              <div className="text-center">
